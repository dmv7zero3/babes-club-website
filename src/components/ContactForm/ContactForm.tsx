...
const ContactForm: React.FC = () => {
  ...
  return (
    <form
      ...
      className="relative space-y-8 rounded-3xl border border-primary-100/70 bg-white p-8 text-neutral-800 shadow-[0_25px_60px_rgba(37,99,235,0.15)]"
      noValidate
    >
      {showStatus ? (
      ...
      <div className="space-y-4 text-slate-700">
        <Checkbox
          label={
            <>
              Keep me informed about community programs, volunteer
              opportunities, and fundraising updates.
              <span className="block text-xs text-slate-500">
                1–2 emails each month. You can opt out at any time.
              </span>
            </>
          }
        ...
        <div className="space-y-2">
          <Checkbox
            label={
              <>
                I consent to Life Missions International contacting me about
                this inquiry.
                <span className="block text-xs text-slate-500">
                  We handle your details per our{" "}
                  <Link
                    to="/privacy-policy"
                    className="text-primary-600 underline decoration-primary-300/80 transition hover:text-primary-700"
                  >
                    Privacy Policy
                  </Link>
                  .
