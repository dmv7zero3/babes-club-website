  ...
  const statusMessage =
    ...
    (formState.status === "error"
      ...
      : formState.isDuplicate
        ...
        : "Welcome to Life Missions International — expect updates soon.");

  const containerClassName = twMerge(
    "relative isolate overflow-hidden rounded-[32px] bg-primary-700",
    className
  );

  const contentWrapperClassName = twMerge(
    "relative flex flex-col overflow-hidden bg-primary-600/25 backdrop-blur-xl lg:flex-row",
  ...
  return (
    <section ref={sectionRef} className={containerClassName}>
      ...
      <div className={contentWrapperClassName}>
        <figure
          data-subscriber-figure
          className="relative h-80 w-full overflow-hidden bg-primary-800/40 lg:h-auto lg:w-5/12"
        >
          <img
            src={imageSrc}
        ...
        >
          ...
          >
            ...
            <div className="space-y-3">
              <Checkbox
                label="Yes, keep me informed about Life Missions International updates."
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-white px-6 py-3 text-xs font-semibold uppercase tracking-[0.35em] text-primary-700 transition hover:bg-white/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-primary-700 disabled:cursor-not-allowed disabled:opacity-70"
              >
                <span
