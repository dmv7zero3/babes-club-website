      ...
      <div className="space-y-3">
        ...
        >
          <div className="flex items-start space-x-3">
            ...
            <div className="text-base transition-colors sm:text-lg text-warm-ivory-200 group-hover:text-heritage-gold">
              <p>{address.street}</p>
              <p>
        ...
        >
          ...
          <span className="text-base transition-colors sm:text-lg text-warm-ivory-200 group-hover:text-heritage-gold">
        ...
        >
          ...
          <span className="text-base break-all transition-colors sm:text-lg text-warm-ivory-200 group-hover:text-heritage-gold">
            {email}
          </span>
        </a>
