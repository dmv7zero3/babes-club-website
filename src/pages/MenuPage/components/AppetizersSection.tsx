...
const AppetizersSection: React.FC = () => {
  const appetizers = foodMenu.menu.appetizers;
  if (!appetizers) {
    return null;
  }
  if (!appetizers || !appetizers.title) {
    return (
      ...
      <main className="w-11/12 mx-auto max-w-7xl ">
        <section className="mb-12 ">
          ...
          <ul className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 ">
            {appetizers.items && appetizers.items.length > 0 ? (
              ...
              <li className="py-4 italic text-gray-500">
