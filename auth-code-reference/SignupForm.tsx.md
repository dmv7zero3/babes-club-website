...
import { useAuth, isValidEmail, isValidPassword, getPasswordStrength } from '../lib/auth';
...
export const SignupForm: React.FC<SignupFormProps> = ({
  ...
  const passwordError = touched.password && !passwordValidation.valid
  ...
  const termsError = touched.terms && requireTerms && !acceptedTerms
  ...
  ), [email, password, confirmPassword, acceptedTerms, requireTerms, passwordValidation]);
  ...
  }, [email, password, displayName, isFormValid, isSubmitting, signup, clearError, onSuccess]);
      ...
      <div style={styles.container} className={className}>
        <div style={styles.card}>
          ...
          <form onSubmit={handleSubmit} style={styles.form} noValidate>
            ...
            {termsError && (
              <span style={styles.fieldError}>{termsError}</span>
            )}
